...
bool reduce_rule_4(vector<list> &seq, int u, int v, int w)
{
  ...
  //if((seq[v].value[2] == seq[u].value[0]) && (seq[v].value[1] != seq[u].value[1]) && (seq[v].value[1] != seq[u].value[2]) && exchange(seq, u, v, w))
if((seq[v].value[2] == seq[u].value[0]) && (seq[v].value[1] != seq[u].value[1]) && (seq[v].value[1] != seq[u].value[2]))
  {
    if((seq[u].usd <= 1) || (seq[v].usd <= 1))
    {
...
{
  //if((seq[w].value[1] == seq[u].value[0]) && (seq[w].value[2] == seq[v].value[0]) && exchange(seq, u, v, w))
  ...
  //if((seq[w].value [2] == seq[u].value[0]) && (seq[w].value[1] == seq[v].value[0]) && exchange(seq, u, v, w))
